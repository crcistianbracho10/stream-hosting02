    ...
    while (true) {
        ...
        for (let i = 0; i < playlist.length; i++) {
            ...
            if (usarCanal11) {
                ...
                filtro += "fontcolor=white:fontsize=42:borderw=3:shadowcolor=black:shadowx=3:shadowy=3:";
            ...
            const esStream = videoURL.endsWith(".m3u8");

            const ffmpegArgs = [
                ...(esStream ? ['-re'] : []), // solo para streams
                '-i', videoURL,
                '-i', 'logo.png',
            ...
            // ✅ Usar duración si está definida
            if (duracion > 0) {
